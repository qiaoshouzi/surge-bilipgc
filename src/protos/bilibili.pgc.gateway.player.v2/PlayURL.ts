...
export interface PlayViewReq {
    ...
    materialNo: number;
    /**
     * @generated from protobuf field: int32 security_level = 19;
     */
    ...
    seasonId: number;
    /**
     * @generated from protobuf field: bilibili.pgc.gateway.player.v2.DataControl data_control = 21;
     */
...
class ContinuePlayInfo$Type extends MessageType<ContinuePlayInfo> {
    constructor() {
        super("bilibili.pgc.gateway.player.v2.ContinuePlayInfo", [
            { no: 1, name: "continue_play_ep_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 continue_play_ep_id */ 1:
                    message.continuePlayEpId = reader.int64().toNumber();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class MultiView$Type extends MessageType<MultiView> {
    constructor() {
        super("bilibili.pgc.gateway.player.v2.MultiView", [
            ...
            { no: 2, name: "ep_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 3, name: "cid", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 4, name: "avid", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 cid */ 3:
                    ...
                    break;
                case /* int64 avid */ 4:
                    message.avid = reader.int64().toNumber();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class PayTip$Type extends MessageType<PayTip> {
    constructor() {
        super("bilibili.pgc.gateway.player.v2.PayTip", [
            ...
            { no: 13, name: "view_start_time", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 view_start_time */ 13:
                    message.viewStartTime = reader.int64().toNumber();
                    break;
...
class PlayViewReq$Type extends MessageType<PlayViewReq> {
    ...
    create(value?: PartialMessage<PlayViewReq>): PlayViewReq {
        const message = { epId: 0, cid: 0, qn: 0, fnver: 0, fnval: 0, download: 0, forceHost: 0, fourk: false, spmid: "", fromSpmid: "", teenagersMode: 0, preferCodecType: 0, isPreview: false, roomId: 0, isNeedViewInfo: false, inlineScene: 0, materialNo: 0, securityLevel: 0, seasonId: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
// @generated message type with reflection information, may provide speed optimized methods
class DataControl$Type extends MessageType<DataControl> {
    constructor() {
    ...
    create(value?: PartialMessage<DataControl>): DataControl {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<DataControl>(this, message, value);
        return message;
    }
...
class ViewInfo$Type extends MessageType<ViewInfo> {
    constructor() {
        super("bilibili.pgc.gateway.player.v2.ViewInfo", [
            ...
            { no: 4, name: "demand_no_pay_epids", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
                ...
                case /* repeated int64 demand_no_pay_epids */ 4:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.demandNoPayEpids.push(reader.int64().toNumber());
                    else
                        message.demandNoPayEpids.push(reader.int64().toNumber());
                    break;
